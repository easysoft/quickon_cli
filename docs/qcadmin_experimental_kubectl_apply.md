## qcadmin experimental kubectl apply
...
```
qcadmin experimental kubectl apply (-f FILENAME | -k DIRECTORY)
```
...
* [qcadmin experimental kubectl apply edit-last-applied](qcadmin_experimental_kubectl_apply_edit-last-applied.md)	 - Edit latest last-applied-configuration annotations of a resource/object
* [qcadmin experimental kubectl apply set-last-applied](qcadmin_experimental_kubectl_apply_set-last-applied.md)	 - Set the last-applied-configuration annotation on a live object to match the contents of a file
* [qcadmin experimental kubectl apply view-last-applied](qcadmin_experimental_kubectl_apply_view-last-applied.md)	 - View the latest last-applied-configuration annotations of a resource/object
