## qcadmin experimental kubectl alpha auth whoami
...
* [qcadmin experimental kubectl alpha auth](qcadmin_experimental_kubectl_alpha_auth.md)	 - Inspect authorization
