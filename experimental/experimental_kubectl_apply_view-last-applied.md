---
sidebarTitle: experimental kubectl apply view-last-applied
sidebarOrder: 1
---

## experimental kubectl apply view-last-applied
...
```
qcadmin experimental kubectl apply view-last-applied (TYPE [NAME | -l label] | TYPE/NAME | -f FILENAME)
```
