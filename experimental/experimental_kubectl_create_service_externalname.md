---
sidebarTitle: experimental kubectl create service externalname
sidebarOrder: 1
---

## experimental kubectl create service externalname
...
```
qcadmin experimental kubectl create service externalname NAME --external-name external.name [--dry-run=server|client|none]
```
...
* [qcadmin experimental kubectl create service](experimental_kubectl_create_service.md)	 - Create a service using a specified subcommand
