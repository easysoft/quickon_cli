---
sidebarTitle: experimental kubectl autoscale
sidebarOrder: 1
---

## experimental kubectl autoscale
...
```
qcadmin experimental kubectl autoscale (-f FILENAME | TYPE NAME | TYPE/NAME) [--min=MINPODS] --max=MAXPODS [--cpu-percent=CPU]
```
