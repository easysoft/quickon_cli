---
sidebarTitle: experimental kubectl taint
sidebarOrder: 1
---

## experimental kubectl taint
...
```
qcadmin experimental kubectl taint NODE NAME KEY_1=VAL_1:TAINT_EFFECT_1 ... KEY_N=VAL_N:TAINT_EFFECT_N
```
