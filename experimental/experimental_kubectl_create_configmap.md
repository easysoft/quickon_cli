---
sidebarTitle: experimental kubectl create configmap
sidebarOrder: 1
---

## experimental kubectl create configmap
...
```
qcadmin experimental kubectl create configmap NAME [--from-file=[key=]source] [--from-literal=key1=value1] [--dry-run=server|client|none]
```
