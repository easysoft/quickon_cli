---
sidebarTitle: experimental kubectl annotate
sidebarOrder: 1
---

## experimental kubectl annotate
...
```
qcadmin experimental kubectl annotate [--overwrite] (-f FILENAME | TYPE NAME) KEY_1=VAL_1 ... KEY_N=VAL_N [--resource-version=version]
```
