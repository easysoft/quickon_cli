---
sidebarTitle: experimental kubectl label
sidebarOrder: 1
---

## experimental kubectl label
...
```
qcadmin experimental kubectl label [--overwrite] (-f FILENAME | TYPE NAME) KEY_1=VAL_1 ... KEY_N=VAL_N [--resource-version=version]
```
