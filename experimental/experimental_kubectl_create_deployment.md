---
sidebarTitle: experimental kubectl create deployment
sidebarOrder: 1
---

## experimental kubectl create deployment
...
```
qcadmin experimental kubectl create deployment NAME --image=image -- [COMMAND] [args...]
```
