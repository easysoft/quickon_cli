---
sidebarTitle: experimental kubectl scale
sidebarOrder: 1
---

## experimental kubectl scale
...
```
qcadmin experimental kubectl scale [--resource-version=version] [--current-replicas=count] --replicas=COUNT (-f FILENAME | TYPE NAME)
```
