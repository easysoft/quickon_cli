---
sidebarTitle: experimental kubectl create clusterrolebinding
sidebarOrder: 1
---

## experimental kubectl create clusterrolebinding
...
```
qcadmin experimental kubectl create clusterrolebinding NAME --clusterrole=NAME [--user=username] [--group=groupname] [--serviceaccount=namespace:serviceaccountname] [--dry-run=server|client|none]
```
...
* [qcadmin experimental kubectl create](experimental_kubectl_create.md)	 - Create a resource from a file or from stdin
