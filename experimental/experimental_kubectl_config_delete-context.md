---
sidebarTitle: experimental kubectl config delete-context
sidebarOrder: 1
---

## experimental kubectl config delete-context
...
```
qcadmin experimental kubectl config delete-context NAME
```
