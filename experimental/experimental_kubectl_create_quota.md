---
sidebarTitle: experimental kubectl create quota
sidebarOrder: 1
---

## experimental kubectl create quota
...
```
qcadmin experimental kubectl create quota NAME [--hard=key1=value1,key2=value2] [--scopes=Scope1,Scope2] [--dry-run=server|client|none]
```
