---
sidebarTitle: experimental kubectl apply edit-last-applied
sidebarOrder: 1
---

## experimental kubectl apply edit-last-applied
...
```
qcadmin experimental kubectl apply edit-last-applied (RESOURCE/NAME | -f FILENAME)
```
...
* [qcadmin experimental kubectl apply](experimental_kubectl_apply.md)	 - Apply a configuration to a resource by file name or stdin
