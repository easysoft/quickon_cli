---
sidebarTitle: experimental kubectl create role
sidebarOrder: 1
---

## experimental kubectl create role
...
```
qcadmin experimental kubectl create role NAME --verb=verb --resource=resource.group/subresource [--resource-name=resourcename] [--dry-run=server|client|none]
```
