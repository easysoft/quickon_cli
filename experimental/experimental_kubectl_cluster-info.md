---
sidebarTitle: experimental kubectl cluster-info
sidebarOrder: 1
---

## experimental kubectl cluster-info
...
```
qcadmin experimental kubectl cluster-info [flags]
```
...
* [experimental kubectl cluster-info dump](experimental_kubectl_cluster-info_dump.md)	 - Dump relevant information for debugging and diagnosis
