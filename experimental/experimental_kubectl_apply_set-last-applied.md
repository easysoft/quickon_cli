---
sidebarTitle: experimental kubectl apply set-last-applied
sidebarOrder: 1
---

## experimental kubectl apply set-last-applied
...
```
qcadmin experimental kubectl apply set-last-applied -f FILENAME
```
