---
sidebarTitle: experimental kubectl create secret generic
sidebarOrder: 1
---

## experimental kubectl create secret generic
...
```
qcadmin experimental kubectl create secret generic NAME [--type=string] [--from-file=[key=]source] [--from-literal=key1=value1] [--dry-run=server|client|none]
```
