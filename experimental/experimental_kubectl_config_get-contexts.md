---
sidebarTitle: experimental kubectl config get-contexts
sidebarOrder: 1
---

## experimental kubectl config get-contexts
...
```
qcadmin experimental kubectl config get-contexts [(-o|--output=)name)]
```
