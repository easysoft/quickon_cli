---
sidebarTitle: experimental kubectl set resources
sidebarOrder: 1
---

## experimental kubectl set resources
...
```
qcadmin experimental kubectl set resources (-f FILENAME | TYPE NAME)  ([--limits=LIMITS & --requests=REQUESTS]
```
