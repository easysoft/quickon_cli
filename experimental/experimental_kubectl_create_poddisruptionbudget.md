---
sidebarTitle: experimental kubectl create poddisruptionbudget
sidebarOrder: 1
---

## experimental kubectl create poddisruptionbudget
...
```
qcadmin experimental kubectl create poddisruptionbudget NAME --selector=SELECTOR --min-available=N [--dry-run=server|client|none]
```
