---
sidebarTitle: experimental kubectl create ingress
sidebarOrder: 1
---

## experimental kubectl create ingress
...
```
qcadmin experimental kubectl create ingress NAME --rule=host/path=service:port[,tls[=secret]] 
```
