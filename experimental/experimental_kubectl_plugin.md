---
sidebarTitle: experimental kubectl plugin
sidebarOrder: 1
---

## experimental kubectl plugin
...
```
qcadmin experimental kubectl plugin [flags]
```
...
* [experimental kubectl plugin list](experimental_kubectl_plugin_list.md)	 - List all visible plugin executables on a user's PATH
