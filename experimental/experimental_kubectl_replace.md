---
sidebarTitle: experimental kubectl replace
sidebarOrder: 1
---

## experimental kubectl replace
...
```
qcadmin experimental kubectl replace -f FILENAME
```
...
```
  ...
  -R, --recursive                       Process the directory used in -f, --filename recursively. Useful when you want to manage related manifests organized within the same directory.
      ...
      --subresource string              If specified, replace will operate on the subresource of the requested object. This flag is beta and may change in the future.
