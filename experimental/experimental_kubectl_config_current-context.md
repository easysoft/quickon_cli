---
sidebarTitle: experimental kubectl config current-context
sidebarOrder: 1
---

## experimental kubectl config current-context
...
```
qcadmin experimental kubectl config current-context [flags]
```
