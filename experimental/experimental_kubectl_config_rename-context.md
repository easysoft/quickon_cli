---
sidebarTitle: experimental kubectl config rename-context
sidebarOrder: 1
---

## experimental kubectl config rename-context
...
```
qcadmin experimental kubectl config rename-context CONTEXT_NAME NEW_NAME
```
