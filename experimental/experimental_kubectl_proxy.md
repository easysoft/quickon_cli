---
sidebarTitle: experimental kubectl proxy
sidebarOrder: 1
---

## experimental kubectl proxy
...
```
qcadmin experimental kubectl proxy [--port=PORT] [--www=static-dir] [--www-prefix=prefix] [--api-prefix=prefix]
```
