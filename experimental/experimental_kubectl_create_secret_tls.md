---
sidebarTitle: experimental kubectl create secret tls
sidebarOrder: 1
---

## experimental kubectl create secret tls
...
```
qcadmin experimental kubectl create secret tls NAME --cert=path/to/cert/file --key=path/to/key/file [--dry-run=server|client|none]
```
