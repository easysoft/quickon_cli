---
sidebarTitle: experimental kubectl port-forward
sidebarOrder: 1
---

## experimental kubectl port-forward
...
```
qcadmin experimental kubectl port-forward TYPE/NAME [options] [LOCAL_PORT:]REMOTE_PORT [...[LOCAL_PORT_N:]REMOTE_PORT_N]
```
