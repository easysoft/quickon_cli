---
sidebarTitle: experimental kubectl set selector
sidebarOrder: 1
---

## experimental kubectl set selector
...
```
qcadmin experimental kubectl set selector (-f FILENAME | TYPE NAME) EXPRESSIONS [--resource-version=version]
```
