---
sidebarTitle: experimental kubectl create cronjob
sidebarOrder: 1
---

## experimental kubectl create cronjob
...
```
qcadmin experimental kubectl create cronjob NAME --image=image --schedule='0/5 * * * ?' -- [COMMAND] [args...] [flags]
```
