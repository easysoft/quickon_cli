---
sidebarTitle: experimental kubectl create priorityclass
sidebarOrder: 1
---

## experimental kubectl create priorityclass
...
```
qcadmin experimental kubectl create priorityclass NAME --value=VALUE --global-default=BOOL [--dry-run=server|client|none]
```
