---
sidebarTitle: experimental kubectl top pod
sidebarOrder: 1
---

## experimental kubectl top pod
...
* [qcadmin experimental kubectl top](experimental_kubectl_top.md)	 - Display resource (CPU/memory) usage
