---
sidebarTitle: experimental kubectl apply
sidebarOrder: 1
---

## experimental kubectl apply
...
* [experimental kubectl apply edit-last-applied](experimental_kubectl_apply_edit-last-applied.md)	 - Edit latest last-applied-configuration annotations of a resource/object
* [experimental kubectl apply set-last-applied](experimental_kubectl_apply_set-last-applied.md)	 - Set the last-applied-configuration annotation on a live object to match the contents of a file
* [experimental kubectl apply view-last-applied](experimental_kubectl_apply_view-last-applied.md)	 - View the latest last-applied-configuration annotations of a resource/object
