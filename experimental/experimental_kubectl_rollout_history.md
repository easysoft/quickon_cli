---
sidebarTitle: experimental kubectl rollout history
sidebarOrder: 1
---

## experimental kubectl rollout history
...
```
qcadmin experimental kubectl rollout history (TYPE NAME | TYPE/NAME) [flags]
```
